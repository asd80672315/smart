    ...
    <!-- Register Form -->
      ...
      <div class="register center-block">
        <form action="${pageContext.request.contextPath }/reservation/saveReservation" method="post" class="form-horizontal formRegister" id="formRegister" onsubmit="return validatePersonalForm()"> 
          <h2>请输入 <span class="red"><strong>企业</strong></span> 信息</h2>
          ...
          <div class="form-group">
            <label for="Name" class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label"><span class="requiredInputForm">*</span>企业名称</label>
          ...
          <div class="form-group">
           <label for="TechnicalField" class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label"><span class="requiredInputForm">*</span>技术领域</label>
           <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
             <input class="form-control" type="text" id="TechnicalField" name="TechnicalField" value="${pd.TechnicalField }" placeholder="请输入您的技术领域..." data-toggle="popover" data-placement="right" onblur="validateTechnicalField()" onfocus="cleanPopover()"><span style="color:red;font-size:10px">${error.phone }</span>
           </div>
         	</div><!-- /#TechnicalField -->
         	
         	<div class="form-group">
           <label for="Contact" class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label"><span class="requiredInputForm">*</span>联系人</label>
           <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
             <input class="form-control" type="text" id="Contact" name="Contact" value="${pd.Contact }" placeholder="请输入联系人..." data-toggle="popover" data-placement="right" onblur="validateContact()" onfocus="cleanPopover()"><span style="color:red;font-size:10px">${error.phone }</span>
           </div>
         	</div><!-- /#Contact -->
          ...
          <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
              <input class="form-control" type="text" id="Email" name="Email" value="${pd.Email }" placeholder="请输入您的电子邮箱..."><span style="color:red;font-size:10px">${error.mail }</span>
            </div>
          </div><!-- /#Mail -->
