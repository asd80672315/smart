        ...
        <div id="row2" class="row">
            <div>
                ...
                <div id="dietChinese1">
                		...
                		<p>您所选取的套餐，总热量较高，蛋白质、动物脂肪含量偏高，维生素及膳食纤维含量偏低。如您有高血压、心血管或消化系统方面的潜在健康问题，建议选择其他套餐。</p>
										<p>用餐建议：</p>
										<p>1.适当补充维生素及纤维素的摄取，以保持营养平衡；</p>
										<p>2. 建议适当增加运动，以免造成脂肪囤积。欢迎您到智能游戏体验区进行游戏体验，以消耗多余热量。</p>
                	</div>
            </div>
        </div>
    </div>
