        ...
        <div id="row2" class="row">
            <div>
                <div class="chinese" id="chinese1">
                	...
                	<div class="chineseFood">
                		<div class="chineseFood1">
                			<img id="hongshaorou" alt="红烧肉" src="${pageContext.request.contextPath }/static/img/Image/west2/fashiwoniu.jpg" width="117px" height="117px">
                		</div>
                		<div class="chineseFood2">
                			<img id="tangcupaigu" alt="糖醋排骨" src="${pageContext.request.contextPath }/static/img/Image/west2/zhishijulongxia.jpg" width="117px" height="117px">
                		</div>
                		...
                		<div class="chineseFood3">
                			<img id="culiutudousi" alt="醋溜土豆丝" src="${pageContext.request.contextPath }/static/img/Image/west2/naiyouhaixiantang.jpg" width="117px" height="117px">
                		</div>
                		<div class="chineseFood4">
                			<img id="suanlatang" alt="酸辣汤" src="${pageContext.request.contextPath }/static/img/Image/west2/mangguobuding.jpg" width="117px" height="117px">
                		</div>
                ...
                <div id="dietChinese1">
                		...
                		<p>您所选取的套餐，总热量较高。其中高嘌呤食材较多，如长期或大量食用有可能诱发痛风病症。维生素及膳食纤维含量较少，应适当补充。</p>
										<p>用餐建议：</p>
										<p>1.用餐时尽量避免或减少饮酒；</p>
										<p>2.适量补充膳食纤维，如蔬菜及水果。</p>
										<p>3.建议适当增加运动，以免造成脂肪囤积，欢迎您到智能游戏体验区进行游戏体验，以消耗多余热量。</p>
                	</div>
            </div>
        </div>
    </div>
