        ...
        <div id="row2" class="row">
            <div>
                <div class="chinese" id="chinese1">
                	...
                	<div class="chineseFood">
                		<div class="chineseFood1">
                			<img id="hongshaorou" alt="红烧肉" src="${pageContext.request.contextPath }/static/img/Image/west1/kaisashala.jpg" width="117px" height="117px">
                		</div>
                		<div class="chineseFood2">
                			<img id="tangcupaigu" alt="糖醋排骨" src="${pageContext.request.contextPath }/static/img/Image/west1/heihujiaoniupai.jpg" width="117px" height="117px">
                		</div>
                		...
                		<div class="chineseFood3">
                			<img id="culiutudousi" alt="醋溜土豆丝" src="${pageContext.request.contextPath }/static/img/Image/west1/fanqieniuweitang.jpg" width="117px" height="117px">
                		</div>
                		<div class="chineseFood4">
                			<img id="suanlatang" alt="酸辣汤" src="${pageContext.request.contextPath }/static/img/Image/west1/heisenlindangao.jpg" width="117px" height="117px">
                		</div>
                ...
                <div id="dietChinese1">
                		...
                		<p>您所选取的套餐，套餐总热量适中，营养元素搭配均衡。</p>
										<p>用餐建议：</p>
										<p>1.甜品热量较高，不建议大量食用；</p>
