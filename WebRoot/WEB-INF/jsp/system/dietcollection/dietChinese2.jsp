        ...
        <div id="row2" class="row">
            <div>
                <div class="chinese" id="chinese1">
                	...
                	<div class="chineseFood">
                		<div class="chineseFood1">
                			<img id="hongshaorou" alt="红烧肉" src="${pageContext.request.contextPath }/static/img/Image/chinese2/xiqinbaihe.jpg" width="117px" height="117px">
                		</div>
                		<div class="chineseFood2">
                			<img id="tangcupaigu" alt="糖醋排骨" src="${pageContext.request.contextPath }/static/img/Image/chinese2/fanqiechaodan.jpg" width="117px" height="117px">
                		</div>
                		...
                		<div class="chineseFood3">
                			<img id="culiutudousi" alt="醋溜土豆丝" src="${pageContext.request.contextPath }/static/img/Image/chinese2/mapodoufu.jpg" width="117px" height="117px">
                		</div>
                		<div class="chineseFood4">
                			<img id="suanlatang" alt="酸辣汤" src="${pageContext.request.contextPath }/static/img/Image/chinese2/huluobopaigutang.jpg" width="117px" height="117px">
                		</div>
                ...
                <div id="dietChinese1">
                		...
                		<p>您所选取的套餐，套餐总热量较低，含有较为丰富的维生素及膳食纤维，利于消化。但其中部分食材会引起血压降低，如您有低血压方面的健康问题，建议选取其他套餐。</p>
										<p>用餐建议：</p>
										<p>适当补充糖分或碳水化合物，以保证足够的热量摄入。</p>
                	</div>
            </div>
        </div>
    </div>
